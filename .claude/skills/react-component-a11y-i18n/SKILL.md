...
- No hardcoded user-facing strings — go through your translation layer
- Semantic HTML by default; ARIA only on custom interactives
- Keyboard accessible; focus trap modals/drawers
- Target WCAG 2.1 AA
